...
async function seedDatabase() {
  try {
    ...
    if (existingActors > 0) {
      console.log('[WARN] Database already contains data. Skipping seed.');
    ...
    console.log('[OK] Directors seeded');
    ...
    console.log('[OK] Episodes seeded');
    ...
    console.log('[OK] Companions seeded');
    ...
    console.log('[OK] Characters seeded');
    ...
    console.log('[OK] Doctor-Companions seeded');
    ...
    console.log('[OK] Episode Appearances seeded');
    ...
    console.log('[OK] Episode Locations seeded');
    ...
    console.log('[OK] Enemy Episodes seeded');
